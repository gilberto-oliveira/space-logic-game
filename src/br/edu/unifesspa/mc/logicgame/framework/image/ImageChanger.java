...
/**
 * The <code>ImageChanger</code> is capable of rotating, flipping and rescaling
...
public class ImageChanger {
     ...
     * direction.
     */
    public ImageChanger(int width, int height, float rotationAngle,
     ...
     * and 360 the changer will automatically convert it to a equivalent angle.
     * An angle of 410 degrees will be converted to 50 degrees. An angle of -5
     * degrees will be converted to 355 degrees.
     */
    ...
    public BufferedImage change(BufferedImage source) {
        ...
        BufferedImage newImage = ImageWorker.getInstance().resizeAndFlip(
                source, newWidth, newHeight, isFlipVertical(),
                isFlipHorizontal());
