...
/**
 * Calculate the number of cicles per second of the main loop. To be precise,
 * the calculate() method must be called at every cicle.
 */
public class CiclesPerSecondCalculator {
    ...
    public void draw(Graphics2D g, int x, int y) {
        ...
        tg.fillRect(x, y, fm.stringWidth("99.99") + MARGIN * 2, fm.getAscent()
                + fm.getDescent() + MARGIN * 2);
