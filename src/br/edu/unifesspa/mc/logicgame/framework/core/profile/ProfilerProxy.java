package br.edu.unifesspa.mc.logicgame.framework.core.profile;
...
public class ProfilerProxy implements InvocationHandler {
    ...
    public long getFloatFromMap(Map<Method, Long> map, Method method) {
        if (map.get(method) == null) {
            return 0;
        }
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        long counter = getFloatFromMap(counters, method);
    ...
    public static Object newProfiled(Object obj) {
        return Proxy.newProxyInstance(obj.getClass().getClassLoader(), obj.getClass().getInterfaces(), new ProfilerProxy(obj));
    }
