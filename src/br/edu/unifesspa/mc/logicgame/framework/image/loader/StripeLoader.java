 ...
 * </pre>
 *
 * @author Vin�cius Will generate a list called BadGuy with images named walk0
 * to walk11.
 */
public class StripeLoader extends AbstractLoader {
    ...
    public ImageItemList<ImageItem> load(Element param) {
        ...
        Element imageElem = (Element) param.getElementsByTagName(IMAGE_TAG)
                .item(0);
        if (imageElem == null) {
            throw new IllegalArgumentException(
                    "You must provide an striped image!");
        }
        ...
        BufferedImage imgs[] = ImageWorker.getInstance().splitImage(
                image.getImage(), cols, lines);
