...
/**
 * Controls the main loop. This class will try to update the logics in a fixed
 * rate per second (ups). This guarantees consistence among animations both in
 * high and low speed computers.
 * <p>
    ...
    public MainLoop(LoopSteps loopSteps, int ups, int maxFrameSkips, int noDelaysPerYield) {
        ...
        if (ups < 1) {
            throw new IllegalArgumentException(
                    "You must display at least one frame per second!");
        }
