...
public class KeyManager {
    ...
    /**
     * Associate the component with this <code>KeyManager</code>. All key events
     * of the component will be listened and reported to the associated
     * GameActions.
     *
    ...
    public void setComponent(Component component) {
        ...
        if (component != null) {
			...
			// Allow jgf.input for TAB key and other keys normally used for
            // focus
            // transversal.
